...
export const moduleCatalog: AgrynModule[] = [
  ...
  { id: "mapa", label: "Mapas e talhões", description: "Limites, culturas e áreas produtivas", icon: MapPinned, accent: "emerald", group: "Gestão", href: "./?view=propriedades" },
  ...
  { id: "relatorios", label: "Relatórios", description: "Documentos técnicos e exportação", icon: FileText, accent: "violet", group: "Relatórios", href: "./agryn.html?tab=relatorio" },
