...
export const moduleCatalog: AgrynModule[] = [
  ...
  { id: "diagnostico", label: "Diagnóstico", description: "Análise guiada de sintomas", icon: BrainCircuit, accent: "violet", group: "Inteligência Artificial", href: "./?view=diagnostico", badge: "IA" },
